...
template<typename T>
void
//__attribute__((noinline)) // Uncomment if you want to try find the assembly
...
void
//__attribute__((noinline)) // Uncomment if you want to try find the assembly
 matexp_solution(tensor_t<T> & dst, const tensor_t<T> & A, uint32_t power,
