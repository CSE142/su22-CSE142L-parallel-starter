...
uint64_t* run_threaded_histogram(uint64_t thread_count, uint64_t * data, uint64_t size, uint64_t arg1, uint64_t arg2, uint64_t arg3) {
	TAG_START("histogram", force_cast(histogram),  force_cast(&histogram[256]), false);
	TAG_START("data",  force_cast(data),  force_cast(&data[size]), false);
	for(int i =0; i < 256;i++) {
		histogram[i] = 0;
	}
...
uint64_t* run_private_histogram(uint64_t thread_count, uint64_t * data, uint64_t size, uint64_t arg1, uint64_t arg2, uint64_t arg3) {
	...
	TAG_START("priv. hist", force_cast(private_buckets),  force_cast(&private_buckets[256*thread_count]), false);
